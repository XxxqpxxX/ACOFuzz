...
class ObsBase:
    ...
    def acoupdate(self, logger, is_init_txs, coverage, coverage_up):
        tx = logger.tx
        ...
        insn_coverage_change = coverage
        block_coverage_change = coverage
        coverage_up.append(new_block_coverage)
    ...
    def update(self, logger, is_init_txs, coverage, coverage_up):
        tx = logger.tx
