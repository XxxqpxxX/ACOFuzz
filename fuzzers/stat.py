...
class Stat:
    ...
    def __init__(self, contract_manager, account_manager):
        ...
        self.checkers = [
            overflow(contract_manager, account_manager),
            BlockStateDep(contract_manager, account_manager),
            # BlockStateDep(),
            DangerousDelegatecall(contract_manager, account_manager),
            Leaking(),
            # Leaking(contract_manager, account_manager),
            Locking(contract_manager, account_manager),
            Suicidal(contract_manager, account_manager),
            UnhandledException(contract_manager, account_manager),
            # UnhandledException(),
